...
/* 21 */   private static final Logger log = Logger.getLogger(Stay.class.getName());
/*    */   
...
/*    */   
/*    */   public WalkWithIE(ResourceBundle schema, List<Animation> animations, VariableMap params) {
/* 33 */     super(schema, animations, params);
/*    */   }
/*    */   
...
/* 50 */       log.log(Level.INFO, "IE was hidden ({0}, {1})", new Object[] { getMascot(), this });
...
/* Location:              /home/hakku/code/spamton/Shimeji-ee.jar!/com/group_finity/mascot/action/WalkWithIE.class
